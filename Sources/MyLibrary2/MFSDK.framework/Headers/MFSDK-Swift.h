...
typedef SWIFT_ENUM(NSInteger, MFCurrencyISO, closed) {
...
typedef SWIFT_ENUM(NSInteger, MFKeyType, closed) {
...
typedef SWIFT_ENUM(NSInteger, MFMobileCountryCodeISO, closed) {
...
typedef SWIFT_ENUM(NSInteger, MFNotificationOption, closed) {
...
typedef SWIFT_ENUM(NSInteger, MFPaymentype, closed) {
  MFPaymentypeCard = 0,
  MFPaymentypeToken = 1,
};
